 ...
 *
 * @author Alex Nistor & Akshay Anand
 *
 */
public abstract class ListTest {
    ...
    /**
     * test of retreat() with l2 = (<"a">, <>).
     */
    @Test
    public final void testRetreat1() {
        List<String> l1 = this.createFromArgsRef(0, "a");
        List<String> l2 = this.createFromArgsTest(1, "a");
        l2.retreat();
        assertEquals(l1, l2);
    }

    /**
     * test of retreat() with l2 = (<"a">, <"b">).
     */
    @Test
    public final void testRetreat2() {
        List<String> l1 = this.createFromArgsRef(0, "a", "b");
        List<String> l2 = this.createFromArgsTest(1, "a", "b");
        l2.retreat();
        assertEquals(l1, l2);
    }

    /**
     * test of retreat() with l2 = (<"a">, <"b", "c", "d", "f", "g">).
     */
    @Test
    public final void testRetreat3() {
        List<String> l1 = this.createFromArgsRef(0, "a", "b", "c", "d", "f",
                "g");
        List<String> l2 = this.createFromArgsTest(1, "a", "b", "c", "d", "f",
                "g");
        l2.retreat();
        assertEquals(l1, l2);
    }
    ...
    public final void testRetreat4() {
        List<String> l1 = this.createFromArgsRef(5, "a", "b", "c", "d", "f",
                "g");
        List<String> l2 = this.createFromArgsTest(6, "a", "b", "c", "d", "f",
                "g");
        l2.retreat();
        assertEquals(l1, l2);
    }
